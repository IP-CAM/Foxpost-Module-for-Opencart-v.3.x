...
class RauschFoxpost extends \Opencart\System\Engine\Controller {
    ...
    public function install(): void {
        ...
        if (VERSION >= '4.0.2.0') {
            ...
            $this->model_setting_event->addEvent('rausch_shipping_foxpost_telephone_mask', 'catalog/controller/account/edit/save/before', 'extension/rausch_foxpost/shipping/rausch_foxpost|validateTelephone');
